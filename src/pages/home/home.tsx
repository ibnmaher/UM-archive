...
export const Home = () => {
  return (
    <div className="w-full min-h-screen pb-4 flex pt-24 flex-col items-center justify-center  gap-24 px-4">
      <div className="flex justify-center gap-24">
        <img src={col_logo} className="h-[190px]"></img>
        <img src={uni_logo} className="h-[190px]"></img>
      </div>
